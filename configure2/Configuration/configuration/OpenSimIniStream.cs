...
{
    public partial class OpenSimIniStream : IDisposable
    {
        ...
        public OpenSimIniStream(string filename, bool lockFile = false)
        {
        ...
        /// <param name="filename"></param>
        /// <param name="lockFile"></param>
        public OpenSimIniStream(StreamReader sr, string filename, bool lockFile = false)
        {
            _iniFileNoSections = new List<string>();
            _iniFileSections = new Dictionary<string, List<string>>();
            ...
            _filename = Path.GetFullPath(filename);
            char result;
            result = Convert.ToChar(Environment.NewLine);
            List<string> iniTempFile = new List<string>(sr.ReadToEnd().Split(result));
        ...
        /// <param name="filename"></param>
        /// <param name="lockFile"></param>
        public OpenSimIniStream(FileStream fs, string filename, bool lockFile = false) : this(new StreamReader(fs), filename, lockFile) { }
        ...
        public OpenSimIniStream(StringReader sr, bool closeAfterReading = true)
        {
            _iniFileNoSections = new List<string>();
            _iniFileSections = new Dictionary<string, List<string>>();
