...
namespace OpenSim.Configuration
{
	...
	public class ClassConfigureOpenSim
	{
		...
		private const string fileName = "OpenSim.ini";
				...
				using (TextReader tr = new StreamReader("OpenSim.ini.example"))
				{
					using (TextWriter tw = new StreamWriter("OpenSim.ini"))
					{
						...
						while ((line = tr.ReadLine()) != null)
						{
							...
							// ; NonPhysicalPrimMax = 256, NonPhysicalPrimMax = 1024
							if (line.Contains("; NonPhysicalPrimMax ="))
								line = line.Replace("; NonPhysicalPrimMax = 256", "NonPhysicalPrimMax = \"" + Configure.regionSize + "\"");
							...
							// ; RenderMeshes = false 
							if (line.Contains("; RenderMeshes = false"))
								line = line.Replace("; RenderMeshes = false", "RenderMeshes = true");
							...
							*/
							...
							if (line.Contains("; enable_materials = true"))
								line = line.Replace("; enable_materials = true", "enable_materials = true");
							...
							//	if (line.Contains("YEngine"))
							//	if (line.Contains("; Enabled = true"))
							//	line = line.Replace("; Enabled = true", "Enabled = true");

							//	if (line.Contains("XEngine"))
							//	if (line.Contains("; Enabled = true"))
